...
const DataTable: React.FC<DataTableProps> = ({ data, onRowSelect, onExport }) => {
        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200">
            {paginatedData.map((sensor) => (
              <tr
                key={sensor.id}
                className={`${getStatusRowColor(sensor.status)} transition-colors cursor-pointer`}
                onClick={() => onRowSelect(sensor)}
              >
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="font-medium text-gray-900">{sensor.customerName}</div>
                  <div className="text-sm text-gray-500">{sensor.deploymentDate}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="font-medium text-gray-900">{sensor.sensorAssigned}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
